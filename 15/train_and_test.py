...
file = open('../../../output/15/train-data','w')


for day in range(9,len(Open)-10,1):

	if price_close[day+10]>price_open[day+1]:
		a='1'
	elif price_close[day+10]<=price_open[day+1]:
		a='-1'
	file.write(a)
...
file2 = open('../../../output/15/test-data','w')
