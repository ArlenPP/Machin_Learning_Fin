...
def HighLowHappened(Open,High,Low,over_x_High,over_y_Low):
	if((High >= Open+over_x_High) and (Low > Open-over_y_Low)):
		return 1
	elif((High < Open+over_x_High) and (Low <= Open-over_y_Low)):
		return -1
	elif((High < Open+over_x_High) and (Low > Open-over_y_Low)):
		return 0
	else:
