...
for i in range(0,(my_stock_combination.stock_list[0].TrainEndi - my_stock_combination.stock_list[0].TrainStarti)+1,1):
	...
	label = str(my_stock_combination.stock_list[0].Close[my_stock_combination.stock_list[0].TrainStarti+i] - my_stock_combination.stock_list[0].Open[my_stock_combination.stock_list[0].TrainStarti+i])
	train.write(label)
	number[0] = 1
