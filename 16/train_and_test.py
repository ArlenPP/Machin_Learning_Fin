...
file = open('../../../output/16/train-data','w')


for day in range(9,len(Open)-5,1):

	if price_close[day+5]>price_open[day+1]:
		a='1'
	elif price_close[day+5]<=price_open[day+1]:
		a='-1'
	file.write(a)
...
file2 = open('../../../output/16/test-data','w')
